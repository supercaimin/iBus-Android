...
public class BusLeaveApplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_leave_application);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(R.string.title_leave);
    ...
    public class NetWorkTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            if (currentSelectTarget == SUBMIT_ACTION) {
                return  HttpData.leave(currentChildId,date);
            }
        ...
        protected void onPostExecute(String s) {
            try{
                ...
                if (status){
                    if (currentSelectTarget == SUBMIT_ACTION) {
                        Toast.makeText(BusLeaveApplicationActivity.this, R.string.tip_submitted_successfully, Toast.LENGTH_SHORT).show();
                        BusLeaveApplicationActivity.this.finish();
                    }
                    ...
                    Toast.makeText(BusLeaveApplicationActivity.this, jsonObject.getString("msg"), Toast.LENGTH_SHORT).show();
                }
            }catch (Exception e){
