...
import cn.homecaught.ibus.adapter.TrackListViewAdapter;
...
import cn.homecaught.ibus.view.BusInfoPopWindow;
import cn.homecaught.ibus.R;
import cn.homecaught.ibus.model.UserBean;

public class TrackFragment extends Fragment{
    private List<UserBean> childs;
    private List<LineBean> lines;
    private BusBean currentBus;

    private TrackListViewAdapter listViewAdapter;

    public UserBean getCurrentChild() {
        return currentChild;
    }

    public void setCurrentChild(UserBean currentChild) {
        this.currentChild = currentChild;
        tvTitle.setText("Track(" + currentChild.getUserFirstName() + " " + currentChild.getUserLastName() +")");
    }

    private UserBean currentChild = null;
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                if (status){
                    ...
                    String upId = jsonObject.getJSONObject("info").getJSONObject("on").getString("line_id");
                    String offId = jsonObject.getJSONObject("info").getJSONObject("off").getString("line_id");
